    ...
    <div class="catalog-item-page container-fluid mt-4">
         <div class="row">
            <div class="col-12 col-sm-6 d-flex justify-content-center">
                <div class="card w-73 ">
                    <img class='img-fluid card-img-top' :src= "'http://tajhoney.loc/assets/images/products/' + product.image" alt="Картинка товара">
                </div>
            </div>
            <div class="col-12 col-sm-6 text-left">
                <div class="row">
                    ...
                    <h4 class="ml-sm-4">
                        ...
                        <button class="btn btn-warning ml-4" @click= "addToCart(product)">Добавить в корзину<i class="fa fa-shopping-cart ml-2" style="color: #525252"></i></button>
                    </h4>
...
<style>
    ...
    .catalog-item-page input, .catalog-item-page textarea {
